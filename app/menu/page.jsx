...
export default function MenuPage() {
  ...
  useEffect(() => {
    ...
    if (savedOrders) {
      ...
      // Automatically show orders popup if orders exist and it's the first load
...
const getRemainingMinutes = (order) => {
  ...
  const estimateMinutes = parseInt(order?.estimate_time) // "30 minutes" → 30
    ...
    <div
      key={order.id}
        ...
        router.push(
          ...
          { state: order } // for SPA navigation
        )
      }
